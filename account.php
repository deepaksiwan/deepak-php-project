  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="image/deepak.jpg.jpg" width=100 height=100 alt="deepak kumar" class="img-rounded">
		 </div>
		 <div class="col-md-5">
		<a href="#" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">Deepak Kumar</a>
		...
		<h4 style="font-family:'typo' ">Buddha instutite of technology ,gorakhapur</h4></div></div>
		</p>
      </div>
